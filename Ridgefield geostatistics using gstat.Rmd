...
```{r local-Moran, message=FALSE, warning=FALSE, fig.height=7.15, fig.width=10, fig.align='center', out.width="80%", fig.cap="Map of Local Moran's I for TOC concentrations in Ridgefield A horizon soils. The Global Moran's I parameter is also shown beneath the legend.", results='hide'}
...
```{r lisa-plot, message=FALSE, warning=FALSE, fig.height=7.15, fig.width=10, fig.align='center', out.width="80%", fig.cap="Map of LISA for C.pct concentrations in the Ridgefield A horizon soil data.", results='hide',echo=FALSE}
...
```{r multi-LISA, fig.height=10, fig.width=7.8, fig.align='center', fig.cap="LISA autocorrelation maps for C.pct, Al, Fe, S, As, Cu, Pb, and Zn concentrations in the Ridgefield A horizon soil data.", message=FALSE, warning=FALSE, echo=FALSE}
...
```{r spplot-spdf, fig.height=5, fig.width=8, fig.align='center', out.width="80%", fig.cap="Visualization of spatial point data object for log10-transformed C.pct concentrations in Ridgefield A horizon soil.", message=FALSE, warning=FALSE, results='hold'}
...
```{r TOC-tukey-plot, echo=2:19, fig.width=8, fig.height=7.05, fig.align='center', fig.cap="Map of C.pct concentrations expressed as symbols for concentration ranges (UQR is 75th percentile, upWsk is upper whisker, med is median, LQR is 25th percentile, loWsk is lower whisker). Data are from Ridgefield A horizon soils.", out.width="80%", message=FALSE, warning=FALSE,echo=FALSE}
...
```{r make-variog-obj, message=FALSE, warning=FALSE, fig.align='center', fig.cap="Plot of experimental binned variogram for C.pct in Ridgefield A horizon soils.", fig.height=3.5, fig.width=4.5, out.width="50%"}
...
```{r plot-exp-model-variograms, fig.height=3.6, fig.width=5, fig.align='center', fig.cap="Plot of experimental binned variogram, and exponential variogram model, for Gravel.pct in Ridgefield A horizon soils.", out.width="50%", results='hide', echo=FALSE}
...
rfgrid <- SpatialPoints(grid0, proj4string = UTM50)
...
```{r spplot-kriging-output, fig.width=8, fig.height=5.85, fig.align='center', echo=2, fig.cap="Plots of simple kriging predictions and variance for log-transformed Gravel.pct in Ridgefield A horizon soils.", out.width="75%", warning=FALSE, error=FALSE, results='hold'}
par(oma=c(0,0,0,0))
...
```{r map-krig-mod-pred, fig.height=12.8, fig.width=7.8, fig.align='center', fig.cap="Map showing (a) predictions and (b) variance for kriging model of Gravel.pct in Ridgefield A horizon soils. Sample points are tiny dots.", message=FALSE, warning=FALSE}
